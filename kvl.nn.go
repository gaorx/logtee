...
var dfas = []dfa{
	// ([a-zA-Z0-9]|_|-|:|\.)+
	{[]bool{false, true, true, true, true, true}, []func(rune) int{ // Transitions
		func(r rune) int {
			switch r {
			case 45:
				return 1
	...
	// ([a-zA-Z0-9]|-|\.)*
	{[]bool{true, true, true, true}, []func(rune) int{ // Transitions
		func(r rune) int {
			switch r {
			case 45:
				return 1
...
func parseKvlEntries(line string) (entries []fieldEntry, err error) {
	defer func() {
		if r := recover(); r != nil {
